...
# Gradient check is a way to verify that the gradient is correctly calculated by the user (you)
...
# Gradient descent for linear regression using the Mean Squared Error cost function (MSE)  
